import {
  Typography_default
} from "./chunk-AVU53KLZ.js";
import {
  NoSsr,
  Popper,
  useSlotProps
} from "./chunk-7CSP6JJR.js";
import "./chunk-TJ4LCURM.js";
import {
  useTheme
} from "./chunk-PCTK6EOP.js";
import "./chunk-QQWRAHIV.js";
import "./chunk-ZIJITNQX.js";
import {
  Box_default,
  composeClasses,
...
var _excluded3 = ["scale", "tickNumber"];
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React11.useContext(CartesianContext), _props$axisId = props.axisId, {
    xAxis: {
      [_props$axisId]: {
        scale: xScale,
        tickNumber
  ...
  return (0, import_jsx_runtime7.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime6.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime7.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime6.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React12.useContext(CartesianContext), _props$axisId = props.axisId, {
    yAxis: {
      [_props$axisId]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime8.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime9.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime8.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime8.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ChartsAxis.propTypes = {
  ...
  bottomAxis: import_prop_types6.default.oneOfType([import_prop_types6.default.shape({
    axisId: import_prop_types6.default.string.isRequired,
...
function InteractionProvider({
  ...
  return (0, import_jsx_runtime12.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React16.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime16.jsxs)(ChartsTooltipRow, {
            children: [(0, import_jsx_runtime15.jsx)(ChartsTooltipCell, {
              ...
              className: classes.labelCell,
              children: label ? (0, import_jsx_runtime15.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime15.jsx)(ChartsTooltipCell, {
              className: classes.valueCell,
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React17.useContext(SeriesContext);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React20.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React21.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React21.createContext(init));
...
var HighlighContext = React23.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider({
  ...
  const [data, dispatch] = React23.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
...
var useInteractionItemProps = (scope) => {
  ...
  } = React24.useContext(HighlighContext);
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(Bar, _extends({}, barProps));
}
...
var useCompletedData = () => {
  ...
  const seriesData = (_React$useContext$bar = React26.useContext(SeriesContext).bar) != null ? _React$useContext$bar : {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(React26.Fragment, {
    children: transition((style, {
      ...
      color: color2,
      highlightScope
    }) => (0, import_jsx_runtime22.jsx)(BarElement, _extends({
      id: seriesId,
      dataIndex,
      highlightScope,
      color: color2
...
var ChartsSurface = React28.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime24.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
...
var ChartContainer = React29.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime25.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime25.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime25.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime25.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime25.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime25.jsx)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var ResponsiveChartContainer = React30.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded8);
  const [containerRef, width, height] = useChartDimensions2(inWidth, inHeight);
  return (0, import_jsx_runtime26.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime26.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function DefaultChartsLegend(props) {
  ...
  const theme = useTheme();
  const labelStyle = React31.useMemo(
  ...
  const padding = React31.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React31.useCallback((label, inStyle = {}) => {
  ...
  const seriesWithPosition = React31.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
var BarChart = React32.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime30.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    children: [(0, import_jsx_runtime29.jsx)("g", {
      ...
      children: (0, import_jsx_runtime29.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2
      })
    }), (0, import_jsx_runtime29.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime29.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime29.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime29.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime29.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? BarChart.propTypes = {
  ...
  series: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
    ...
    type: import_prop_types10.default.oneOf(["bar"]),
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(Line, _extends({}, lineProps));
}
...
function LinePlot(props) {
  ...
  const seriesData = React34.useContext(SeriesContext).line;
  const axisData = React34.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime32.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime32.jsx)(LineElement, {
          id: seriesId,
...
function AreaPlot(props) {
  ...
  const seriesData = React36.useContext(SeriesContext).line;
  const axisData = React36.useContext(CartesianContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(MarkElementPath, _extends({}, other, {
    ownerState,
    className: classes.root,
    ...
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return xData == null ? void 0 : xData.map((x2, index2) => {
          ...
          return (0, import_jsx_runtime36.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index2,
            shape: "circle",
            color: series[seriesId].color,
  ...
  return (0, import_jsx_runtime38.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime38.jsx)(Element, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
true ? LineChart.propTypes = {
  ...
  bottomAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
    axisId: import_prop_types19.default.string.isRequired,
  ...
  series: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    area: import_prop_types19.default.bool,
    color: import_prop_types19.default.string,
    connectNulls: import_prop_types19.default.bool,
    curve: import_prop_types19.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
    data: import_prop_types19.default.arrayOf(import_prop_types19.default.number),
    dataKey: import_prop_types19.default.string,
    disableHighlight: import_prop_types19.default.bool,
    ...
    label: import_prop_types19.default.string,
    showMark: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.bool]),
    ...
    type: import_prop_types19.default.oneOf(["line"]),
  ...
  xAxis: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    axisId: import_prop_types19.default.string,
    classes: import_prop_types19.default.object,
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps(highlightScope);
  return (0, import_jsx_runtime41.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React43.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React43.useMemo(() => data.map((item, itemIndex) => {
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime42.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime42.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded20 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
var _excluded21 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
var _excluded24 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime44.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime44.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const seriesData = React47.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
  ...
  return (0, import_jsx_runtime46.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime45.jsx)("g", {
        transform: `translate(${cx === void 0 ? center.x : left + cx}, ${cy === void 0 ? center.y : top + cy})`,
        children: (0, import_jsx_runtime45.jsx)(PieArcPlot, {
          innerRadius,
      ...
      return (0, import_jsx_runtime45.jsx)("g", {
        transform: `translate(${cx === void 0 ? center.x : left + cx}, ${cy === void 0 ? center.y : top + cy})`,
        children: (0, import_jsx_runtime45.jsx)(PieArcLabelPlot, {
          innerRadius,
          outerRadius: outerRadius != null ? outerRadius : availableRadius,
          cornerRadius,
          paddingAngle,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime48.jsxs)(ResponsiveChartContainer, {
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none",
    children: [(0, import_jsx_runtime47.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime47.jsx)(PiePlot, {
      slots,
      slotProps,
      onClick,
      skipAnimation: skipAnimation2
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime47.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime47.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
  ...
  bottomAxis: import_prop_types22.default.oneOfType([import_prop_types22.default.shape({
    axisId: import_prop_types22.default.string.isRequired,
  ...
  series: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
    ...
    cx: import_prop_types22.default.number,
    cy: import_prop_types22.default.number,
    ...
    outerRadius: import_prop_types22.default.number,
    paddingAngle: import_prop_types22.default.number,
    sortingValues: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["asc", "desc", "none"]), import_prop_types22.default.func]),
    startAngle: import_prop_types22.default.number,
    type: import_prop_types22.default.oneOf(["pie"]),
  ...
  xAxis: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
    axisId: import_prop_types22.default.string,
    classes: import_prop_types22.default.object,
...
function Scatter(props) {
  ...
  const cleanData = React49.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
  ...
  return (0, import_jsx_runtime49.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime49.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
      r: markerSize,
...
true ? Scatter.propTypes = {
  ...
  series: import_prop_types23.default.shape({
    ...
    highlightScope: import_prop_types23.default.shape({
      faded: import_prop_types23.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types23.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types23.default.string.isRequired,
    label: import_prop_types23.default.string,
    markerSize: import_prop_types23.default.number,
    type: import_prop_types23.default.oneOf(["scatter"]).isRequired,
    valueFormatter: import_prop_types23.default.func.isRequired,
    xAxisKey: import_prop_types23.default.string,
    yAxisKey: import_prop_types23.default.string
  }).isRequired,
...
function ScatterPlot(props) {
  ...
  const seriesData = React50.useContext(SeriesContext).scatter;
  ...
  return (0, import_jsx_runtime50.jsx)(React50.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      return (0, import_jsx_runtime50.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
...
var ScatterChart = React51.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime52.jsxs)(ResponsiveChartContainer, {
    ...
    yAxis,
    sx,
    children: [(0, import_jsx_runtime51.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime51.jsx)(ScatterPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime51.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime51.jsx)(ChartsAxisHighlight, _extends({
      x: "none",
      y: "none"
    }, axisHighlight)), (0, import_jsx_runtime51.jsx)(ChartsTooltip, _extends({
      trigger: "item"
    }, tooltip)), children]
  });
});
true ? ScatterChart.propTypes = {
  ...
  bottomAxis: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    axisId: import_prop_types25.default.string.isRequired,
  ...
  series: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
    ...
    data: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
      ...
      x: import_prop_types25.default.number.isRequired,
      y: import_prop_types25.default.number.isRequired
    })).isRequired,
    ...
    label: import_prop_types25.default.string,
    markerSize: import_prop_types25.default.number,
    type: import_prop_types25.default.oneOf(["scatter"]),
...
var SparkLineChart = React52.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime54.jsxs)(ResponsiveChartContainer, {
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime53.jsx)(BarPlot, {
      slots,
      slotProps,
      sx: {
        shapeRendering: "auto"
      }
    }), plotType === "line" && (0, import_jsx_runtime54.jsxs)(React52.Fragment, {
      children: [(0, import_jsx_runtime53.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime53.jsx)(LinePlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime53.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime53.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime53.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
