...
var StepButton = React78.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React78.cloneElement(children, childProps) : (0, import_jsx_runtime88.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var Tab = React84.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime95.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime95.jsxs)(React84.Fragment, {
      children: [icon, label]
